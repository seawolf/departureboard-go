...
func (sgb *ServiceGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entities: ServiceGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServiceGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ServiceGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entities: ServiceGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServiceGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ServiceGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entities: ServiceGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServiceGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ServiceGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entities: ServiceGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServiceGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServiceSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entities: ServiceSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServiceSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServiceSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entities: ServiceSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServiceSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServiceSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entities: ServiceSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServiceSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServiceSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entities: ServiceSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServiceSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{service.Label}
	default:
		err = fmt.Errorf("entities: ServiceSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
