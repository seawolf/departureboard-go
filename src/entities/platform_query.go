...
func (pq *PlatformQuery) QueryStation() *StationQuery {
	query := &StationQuery{config: pq.config}
...
func (pq *PlatformQuery) WithStation(opts ...func(*StationQuery)) *PlatformQuery {
	query := &StationQuery{config: pq.config}
...
func (pq *PlatformQuery) sqlAll(ctx context.Context) ([]*Platform, error) {
	...
	if query := pq.withStation; query != nil {
		ids := make([]int, 0, len(nodes))
		nodeids := make(map[int][]*Platform)
		for i := range nodes {
			if nodes[i].station_platforms == nil {
				continue
			}
			fk := *nodes[i].station_platforms
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "station_platforms" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (pgb *PlatformGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entities: PlatformGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PlatformGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PlatformGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entities: PlatformGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PlatformGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PlatformGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entities: PlatformGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PlatformGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PlatformGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entities: PlatformGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PlatformGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PlatformSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entities: PlatformSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PlatformSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PlatformSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entities: PlatformSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PlatformSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PlatformSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entities: PlatformSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PlatformSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PlatformSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entities: PlatformSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PlatformSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{platform.Label}
	default:
		err = fmt.Errorf("entities: PlatformSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
